...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./KYLIE.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("EYE", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S KYLIE -X kill
screen -S KYLIE ./KYLIE
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KYLIE-TEAM/Files_KYLIE/main/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1214622341) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1779861424) then  
var = 'مبرمجة السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:mode:2", user_id) then 
...
KYLIE_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KYLIE_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KYLIE_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KYLIE_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KYLIE_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KYLIE_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KYLIE_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KYLIE_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KYLIE_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KYLIE_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KYLIE_Msg = 'رب التفاعل'  
end 
return KYLIE_Msg 
end
...
function plugin_KYLIE(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.KYLIE and msg then
pre_msg = plugin.KYLIE(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKYLIE(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,KYLIE_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/KYLIE-TEAM/KYLIE/main/KYLIE.lua')
...
send(msg.chat_id_, msg.id_,'꙳.︙عدد الكروبات الان » { '..#group..' }'..KYLIEk..''..KYLIE..'\n꙳.︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local KYLIE1_Msg = database:get(bot_id.."KYLIE1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KYLIE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if KYLIE_Msg and not Special(msg) then  
local KYLIE_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KYLIE_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:sadd(bot_id.."KYLIE:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."KYLIE:blocname"..msg.chat_id_)
...
if name_MRmode then 
names_MRmode = database:smembers(bot_id.."KYLIE:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."KYLIE:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."KYLIE:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."KYLIE:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."KYLIE:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."KYLIE:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function mode_mrmode_new(mrmode1,mrmode2)
if mrmode2 and mrmode2.first_name_ then 
if mrmode2.first_name_:match("(.*)"..database:get(bot_id.."KYLIE:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KYLIE:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrmode_nnn = database:get(bot_id.."KYLIE:nump"..msg.chat_id_) or 5
local mrmode_nnn2 = database:get(bot_id.."KYLIE:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrmode_nnn2) == tonumber(mrmode_nnn) or tonumber(mrmode_nnn2) > tonumber(mrmode_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KYLIE:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "꙳.︙عزيزي >>["..mrmode2.username_.."](https://t.me/"..(mrmode2.username_ or "ppppd")..")\n꙳.︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KYLIE:teh"..msg.chat_id_).."} بجانب اسمك\n꙳.︙عدد المحاولات المتبقيه {"..(tonumber(mrmode_nnn) - tonumber(mrmode_nnn2)).."}")
end
end
end
end
...
local KYLIEChengName = database:get(bot_id.."KYLIE:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KYLIEChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KYLIEChengName..']')
database:del(bot_id.."KYLIE:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KYLIEChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."KYLIE:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KYLIEChengUserName = database:get(bot_id.."KYLIE:Cheng:UserName"..data.id_)
if not data.username_ then 
if KYLIEChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KYLIEChengUserName..']')
database:del(bot_id.."KYLIE:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KYLIEChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."KYLIE:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KYLIEChengPhoto = database:get(bot_id.."KYLIE:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KYLIEChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."KYLIE:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KYLIEChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."KYLIE:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
if Devmode(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KYLIE-TEAM/Files_KYLIE/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/KYLIE-TEAM/Files_KYLIE/main/File_Bot/"..file)
if res == 200 then
...
function Function_KYLIE(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_KYLIE, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_KYLIE, nil)
return false 
end
...
if text then   
database:set(bot_id.."KYLIE1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KYLIE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
local list = database:smembers(bot_id.."KYLIE1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KYLIE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KYLIE1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KYLIE1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ꙳.︙قائمة المنع \n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n"
for k,v in pairs(list) do  
local KYLIE_Msg = database:get(bot_id.."KYLIE1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..KYLIE_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..KYLIE_Msg[math.random(#KYLIE_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:KYLIE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '*\n ꙳.︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id.."botss:KYLIE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:KYLIE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:KYLIE:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:KYLIE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"*꙳.︙تم حذف الرد من ردود المتعدده*")
database:del(bot_id..'botss:KYLIE:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:KYLIE:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:KYLIE:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:KYLIE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:KYLIE:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:KYLIE:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:KYLIE:List:Rd:Sudo")
end
...
database:set(bot_id.."botss:KYLIE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"꙳.︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:KYLIE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:KYLIE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:KYLIE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:KYLIE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:KYLIE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:KYLIE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:KYLIE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:KYLIE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:KYLIE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:KYLIE:Add:Rd:Sudo:Text2"..text)   
...
-- vardump(data) 
KYLIEdx(msg.chat_id_, msg.id_, ' ꙳.︙ايدي المجموعة » ( '..msg.chat_id_..' )\n ꙳.︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ꙳.︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n ꙳.︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
Text = '* ꙳.︙عدد نقاطك التي ربحتها هيه »* { '..Num..' } نقطه '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ولك هيو لتندك بسيادك لو بهاي 👈👞","ميستاهل اتعبي روحي ويا لانه عار","عوفه يروحي هاذا طيز يضل يمضرط🤣","دكلخرا انته لو مومطي متحط عقلك ويه الجهال 😚💞💞"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
≪─━─━─𝙆𝙮━─━─≫
 ...
 ꙳. رابط حذف [Snspchat](https://accounts.KYLIEchat.com/accounts/login?continue=https%3A%2F%2Faccounts.KYLIEchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
KYLIE = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KYLIE)
...
--------------------------------------------------------------------------------------------------------------
SourceKYLIE(data.message_,data)
plugin_KYLIE(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local KYLIEAbot = database:get(bot_id.."KYLIE1:Add:Filter:Rp2"..text..result.chat_id_)   
if KYLIEAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ꙳.︙["..KYLIEAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KYLIE1_Msg = database:get(bot_id.."KYLIE1:Add:Filter:Rp2"..text..result.chat_id_)   
if KYLIE1_Msg then    
send(msg.chat_id_, msg.id_," ꙳.︙"..KYLIE1_Msg)
